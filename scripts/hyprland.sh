...
cd $SCRIPT_DIR
cd ../
node packing.js --monitor "$monitorJson" --windows "$json" --adapter hyprland --gap 10 --marginVertical 0 --marginHorizontal 20 --waybarHeight 50 --activeWorkspace "$active_workspace" --logging false
