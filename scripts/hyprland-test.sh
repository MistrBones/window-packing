...
cd $SCRIPT_DIR
cd ../
node packing.js --monitor "$monitorJson" --windows "$json" --adapter hyprland --gap 20 --marginVertical 40 --marginHorizontal 0 --waybarHeight 50 --activeWorkspace "$active_workspace" --logging false
